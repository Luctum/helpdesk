...
--
-- Client :  127.0.0.1
-- Généré le :  Lun 28 Septembre 2015 à 12:05
...
INSERT INTO `ticket` (`id`, `type`, `idCategorie`, `titre`, `description`, `idStatut`, `idUser`, `dateCreation`, `notif`) VALUES
(2, 'incident', 12, 'impossible de se connecter', 'Impossible de se connecter à mon compte :\r\nLe message affiché est "Les informations de compte n''ont pas permis votre authentification".\r\n\r\nJe n''ai pas trouvé la procédure de récupération de mot de passe.', 3, 3, '2015-05-14 10:40:40', 1),
(3, '', 2, 'eazeazeaz', '<p>bonjour aa</p>\r\n', 1, 2, '2015-09-17 09:31:43', 1),
(4, '', 8, 'aa', '<p>pomme</p>\r\n', 1, 2, '2015-09-21 09:09:49', 1),
(5, 'demande', 4, 'rzerezrz', '<p>eezrz</p>\r\n', 1, 2, '2015-09-28 09:10:19', 1),
(6, 'demande', 4, 'rzerezrz', '<p>eezrz</p>\r\n', 1, 2, '2015-09-28 09:12:43', 1),
(7, 'demande', 4, 'rzerezrz', '<p>eezrz</p>\r\n', 1, 2, '2015-09-28 09:13:50', 1);
